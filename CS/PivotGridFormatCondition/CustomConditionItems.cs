...
namespace FormatCondititonsDesigner
{
    public class ItemCondition
    {
        ...
        PivotGridStyleFormatCondition fcondition;
        public ItemCondition(PivotGridStyleFormatCondition fcondition)
        {
        ...
        public PivotGridStyleFormatCondition Condition { get { return fcondition; } }
    }
}
